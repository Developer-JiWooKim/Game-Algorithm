...
public class ProjectileGizmoPreview : MonoBehaviour
{
    ...
    private void FireProjectile()
    {
        ...
        GameObject projectile = Instantiate(projectilePrefab, muzzlePoint.position, Quaternion.identity,projectiles);
    ...
    private Vector3 GetLaunchVelocity()
    {
        ...
        return rotation * muzzlePoint.forward * launchSpeed;
    }
