...
public class MonsterStateGizmo : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (distance <= attackDistance) currentState = MonsterState.Attack;
        else if (distance <= chaseDistance) currentState = MonsterState.Chase;
        else currentState = MonsterState.Idle;
    }
